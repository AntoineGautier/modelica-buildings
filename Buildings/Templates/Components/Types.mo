...
package Types
  ...
  type DamperBlades = enumeration(
    Opposed "Opposed blades",
    Parallel "Parallel blades",
    VAV "VAV damper")
  ...
  type FanSingle = enumeration(
    Housed "Housed centrifugal fan",
    Plug "Plug fan",
    Propeller "Propeller fan")
    "Enumeration to specify the type of single fan";

  type HeatPump = enumeration(
    AirToWater "Air-to-water heat pump",
    WaterToWater "Water(or brine)-to-water heat pump")
    "Enumeration to specify the heat pump source/sink type";
  ...
  type IntegrationPoint = enumeration(
    ...
    Return "Return side",
    Supply "Supply side")
    "Enumeration to specify the integration point of equipment";

  type Pump = enumeration(
    None "No pump",
    Single "Single pump",
    Multiple "Multiple pumps in parallel")
  ...
  annotation(Documentation(
    info="<html>
  <p>Enumeration that defines the characteristic of two-way valves.</p>
  <table summary=\"summary\" border=\"1\">
    ...
    <tr>
      <td>EqualPercentage</td>
      <td>Equal percentage</td>
    </tr>
    <tr>
      <td>Linear</td>
      <td>Linear</td>
  ...
  annotation(Documentation(
    info="<html>
  <p>Enumeration that defines the characteristic of three-way valves.</p>
  <table summary=\"summary\" border=\"1\">
    <tr>
      <th>Enumeration</th>
      <th>Description</th>
    ...
    <tr>
      <td>EqualPercentageLinear</td>
      <td>Equal percentage (direct) and linear (bypass)</td>
    </tr>
    <tr>
      <td>Linear</td>
      <td>Linear (both direct and bypass)</td>
    </tr>
    <tr>
      <td>Table</td>
      <td>Table-specified (both direct and bypass)</td>
    </tr>
  </table>
  </html>"));
annotation(Documentation(
