...
model WatersideEconomizer "Validation of the base subsystem model with waterside economizer"
  ...
  Fluid.Sources.Boundary_pT bou1(
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0,origin={140,-62})));
  ...
  Fluid.Sensors.TemperatureTwoPort senT1OutPum(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={100,-80})));
  Fluid.Sensors.TemperatureTwoPort senT1InlPum(
    redeclare final package Medium=Medium,
    m_flow_nominal=hexPum.m1_flow_nominal)
    "Primary inlet temperature"
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0,origin={100,-40})));
  ...
  Fluid.Sensors.TemperatureTwoPort senT2InlPum(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={-40,-80})));
  ...
  Fluid.Sources.Boundary_pT bou1Val(
    ...
    nPorts=1)
    "Primary boundary conditions"
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0,origin={142,40})));
  Fluid.Sources.Boundary_pT bou1Val1(
    redeclare package Medium=Medium,
    nPorts=1)
    "Primary boundary conditions"
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0,origin={140,0})));
  ...
  Fluid.Sensors.TemperatureTwoPort senT1OutVal(
    ...
    m_flow_nominal=hexVal.m1_flow_nominal)
    "Primary outlet temperature"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={100,0})));
  ...
  Fluid.Sources.Boundary_pT bou2Val1(
    redeclare package Medium = Medium,
    use_T_in=true,
    nPorts=2)
  ...
  Fluid.Sources.Boundary_pT bou3(
    ...
    nPorts=2)
    "Secondary boundary conditions"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={-140,-80})));
