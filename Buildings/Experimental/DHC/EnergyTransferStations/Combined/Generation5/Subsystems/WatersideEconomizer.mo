...
model WatersideEconomizer "Base subsystem with waterside economizer"
  ...
  Fluid.Sensors.TemperatureTwoPort senT2HexWatEnt(
    ...
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0, origin={40,-60})));
  ...
  Fluid.Actuators.Valves.TwoWayEqualPercentage val1Hex(
    ...
    final dpFixed_nominal=0)              if have_val1Hex "Heat exchanger primary control valve"
...
equation
  ...
  connect(senT2HexWatEnt.port_b, hex.port_a2)
    annotation (Line(points={{30,-60},{20,-60},{20,-6},{10,-6}}, color={0,127,255}));
  connect(senT2HexWatEnt.port_b, val2Hex.port_a) annotation (Line(points={{30,-60},{10,-60}}, color={0,127,255}));
  ...
  connect(senT2HexWatLvg.port_a, val2Hex.port_b) annotation (Line(points={{-30,-60},{-10,-60}}, color={0,127,255}));
