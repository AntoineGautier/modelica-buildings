...
model ChillerBorefield "ETS model for 5GDHC systems with heat recovery chiller and optional borefield"
  extends BaseClasses.PartialParallel(
    ...
    redeclare replaceable Controls.Supervisory conSup(
      final dT12Hex_nominal=dT12Hex_nominal) constrainedby Controls.Supervisory(
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.Junction splWSE(
    ...
    final m_flow_nominal=mDisWat_flow_nominal*{1,-1,-1})
  ...
  Fluid.Sensors.TemperatureTwoPort senT1HexWatEnt(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0, origin={-260,
            -260})));
equation
  ...
  connect(conSup.TChiWatSupSet,chi.TChiWatSupSet)
    annotation (Line(points={{-228,17},{-26,17},{-26,-8},{-12,-8}},color={0,0,127}));
  ...
  connect(conSup.yAmb[1],borFie.u)
    annotation (Line(points={{-228,25},{-200,25},{-200,-212},{-82,-212}},color={0,0,127}));
  ...
  connect(conSup.yCoo, WSE.uCoo) annotation (Line(points={{-228,29},{140,29},{140,
  ...
  connect(port_aSerAmb, senT1HexWatEnt.port_a) annotation (Line(points={{-300,-200},
          {-280,-200},{-280,-260},{-270,-260}}, color={0,127,255}));
  connect(senT1HexWatEnt.port_b, splWSE.port_1)
    annotation (Line(points={{-250,-260},{-230,-260}}, color={0,127,255}));
  connect(conSup.T1HexWatEnt, senT1HexWatEnt.T) annotation (Line(points={{-252,18},
          {-260,18},{-260,-249}}, color={0,0,127}));
  annotation (
    Diagram(
      coordinateSystem(
