...
equation
  ...
  connect(dHFloChiWat.port_b2, WSE.port_a2)
    annotation (Line(points={{268,120},{268,112},{240,112}},           color={0,127,255}));
  connect(WSE.port_b2, tanChiWat.port_aTop) annotation (Line(points={{220,112},{200,112}}, color={0,127,255}));
  ...
  connect(splWSE.port_3, WSE.port_a1)
    annotation (Line(points={{-260,-270},{-260,-280},{210,-280},{210,124},{220,124}}, color={0,127,255}));
  connect(WSE.port_b1, mixWSE.port_3) annotation (Line(points={{240,124},{254,124},{254,-250}}, color={0,127,255}));
  connect(hex.port_b1, mixWSE.port_1) annotation (Line(points={{10,-260},{244,-260}}, color={0,127,255}));
  connect(conSup.yCoo, WSE.uCoo) annotation (Line(points={{-238,29},{140,29},{140,118},{218,118}}, color={255,0,255}));
  annotation (
    Diagram(
      coordinateSystem(
