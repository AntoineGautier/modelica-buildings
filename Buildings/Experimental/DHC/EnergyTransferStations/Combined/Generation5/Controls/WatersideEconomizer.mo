...
equation
  connect(dp2, ratNom2.u) annotation (Line(points={{-200,40},{-160,40},{-160,60},{-142,60}},
    color={0,0,127}));
  connect(dp1, ratNom1.u) annotation (Line(points={{-200,100},{-142,100}}, color={0,0,127}));
  connect(ratNom2.y, conPI.u_s) annotation (Line(points={{-118,60},{-80,60},{-80,100},{-68,100}},    color={0,0,127}));
  ...
  connect(T2HexWatLvg, delT1.u2)
    annotation (Line(points={{-200,-180},{-160,-180},{-160,-146},{-142,-146}},
                                                                             color={0,0,127}));
  connect(delT1.y, delTemDis.u) annotation (Line(points={{-118,-140},{-52,-140}},color={0,0,127}));
  connect(dp2, calTemLvg.dp2) annotation (Line(points={{-200,40},{-160,40},{-160,-35},{-142,-35}},
                                                                                               color={0,0,127}));
  connect(T1HexWatEnt, calTemLvg.T1HexWatEnt)
    annotation (Line(points={{-200,-20},{-160,-20},{-160,-45},{-142,-45}},
                                                                     color={0,0,127}));
  ...
  connect(ena1.outPort, iniSta.inPort[1])
    annotation (Line(points={{101.5,40},{100,40},{100,56},{-40,56},{-40,40},{-31,40}},
                                                                                    color={0,0,0}));
  ...
  connect(uCoo, swiOff1.u2) annotation (Line(points={{-200,140},{80,140},{80,100},{98,100}}, color={255,0,255}));
  ...
  connect(uCoo, not2.u) annotation (Line(points={{-200,140},{-170,140},{-170,-100},{-52,-100}}, color={255,0,255}));
  ...
  connect(delTemDis1.y, mulAnd.u[1])
    annotation (Line(points={{-28,-40},{-20,-40},{-20,-35.3333},{-12,-35.3333}}, color={255,0,255}));
  connect(iniSta.active, tim1.u) annotation (Line(points={{-20,29},{-20,14}}, color={255,0,255}));
  connect(tim1.passed, mulAnd.u[2])
    annotation (Line(points={{-28,-10},{-28,-32},{-12,-32},{-12,-40}}, color={255,0,255}));
  connect(uCoo, mulAnd.u[3]) annotation (Line(points={{-200,140},{-170,140},{-170,-60},{-20,-60},{-20,-44},{-12,-44},{
