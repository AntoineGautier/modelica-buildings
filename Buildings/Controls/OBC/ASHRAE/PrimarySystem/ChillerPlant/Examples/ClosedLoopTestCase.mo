...
model ClosedLoopTestCase
  ...
  Staging.Subsequences.CapacityRequirement capReq(water_spec_heat=cpLiq)
    annotation (Placement(transformation(extent={{-564,198},{-544,218}})));
  ...
  Modelica.Blocks.Sources.RealExpression chi1PLR(y=chi1.PLR1)
    annotation (Placement(transformation(extent={{-652,108},{-632,128}})));
  ...
  Modelica.Blocks.Sources.RealExpression chi2PLR1(y=chi2.PLR1)
    annotation (Placement(transformation(extent={{-652,80},{-632,100}})));
  ...
  Staging.Subsequences.Capacities staCap(staNomCap=q_floEva_nominal*{1,2})
  ...
  CDL.Logical.Sources.Constant chi1Ava(k=true) "Chiller availability "
    annotation (Placement(transformation(extent={{-654,180},{-634,200}})));
  CDL.Logical.Sources.Constant chi2Ava(k=true) "Chiller availability "
    annotation (Placement(transformation(extent={{-654,146},{-634,166}})));
  ...
  CDL.Continuous.LimPID con_valTowByp(
    ...
    k=1,
    reverseAction=true)
    annotation (Placement(transformation(extent={{-512,302},{-492,322}})));
  ...
  CDL.Continuous.Sources.Constant set_m_floPumCW(k=m_floCW_nominal)
    ...
    annotation (Placement(transformation(extent={{-654,374},{-634,394}})));
...
equation
  ...
  connect(sen_TCHWRet.T, capReq.TChiWatRet) annotation (Line(
      points={{-97,-8},{-586,-8},{-586,208},{-565,208}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(sen_V_floCHW.V_flow, capReq.VChiWat_flow) annotation (Line(
      points={{-97,22},{-580,22},{-580,203},{-565,203}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(from_degC.y, capReq.TChiWatSupSet) annotation (Line(
      points={{-595,420},{-586,420},{-586,213},{-565,213}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(con_pumCHW.y, pumCHW1.y) annotation (Line(
      points={{-381,157},{-64.5,157},{-64.5,116},{-66,116}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(con_pumCHW.y, pumCHW2.y) annotation (Line(
      points={{-381,157},{-59.5,157},{-59.5,76},{-62,76}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(chi1Ava.y, staCap.u[1]) annotation (Line(points={{-633,190},{-576,190},
          {-576,238},{-522,238}}, color={255,0,255}));
  connect(chi2Ava.y, staCap.u[2]) annotation (Line(points={{-633,156},{-576,156},
          {-576,238},{-522,238}}, color={255,0,255}));
  ...
  connect(con_valTowByp.y, valTowByp.y) annotation (Line(
      points={{-491,312},{368,312},{368,194},{356,194}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(sen_TCWLvgTow.T, con_cooTowFan.TConWatRet) annotation (Line(
      points={{328,246},{328,304},{-304,304},{-304,340},{-290,340}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(from_degC1.y, con_valTowByp.u_s)
    annotation (Line(points={{-597,312},{-514,312}}, color={0,0,127}));
  ...
  connect(set_m_floPumCW.y, pumCW1.m_flow_in) annotation (Line(
      points={{-633,384},{312,384},{312,156}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(set_m_floPumCW.y, pumCW2.m_flow_in) annotation (Line(
      points={{-633,384},{311.5,384},{311.5,122},{312,122}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(sen_TCWEntCon.T, con_valTowByp.u_m) annotation (Line(
      points={{252,155},{252,178},{-502,178},{-502,300}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false,
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Examples/ClosedLoopTestCase.mos"
        "Simulate and plot"),
    Icon(coordinateSystem(extent={{-700,-120},{400,460}})));
